#!/usr/bin/env python3
"""导出单细胞免疫分析结论到 workspace/artifacts/sc_immune_conclusion.json。"""
...
def export_sc_immune(workspace_dir: str = "workspace") -> Path:
    out_dir = Path(workspace_dir) / "artifacts"
...
if __name__ == "__main__":
    ...
    path = export_sc_immune(ws)
    print(f"✅ sc_immune_conclusion.json 已导出到 {path}")
