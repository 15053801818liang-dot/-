...
```bash
# 运行 REPL
cd 盘古 && python3 pangu_v0.12.0.py

# MCP 模式（JSON stdin/stdout）
python3 pangu_v0.12.0.py --mcp

# 测试
python3 test_pangu_v0.10.0.py && python3 test_comprehensive.py && python3 test_pangu_v011.py && python3 test_pangu_v012.py
```
